...
export default function AdminPodgladScreen() {
  ...
  const renderItem = ({ item }: { item: any }) => {
    ...
    return (
      <TouchableOpacity
        ...
        onPress={() =>
          router.push({
            pathname: "/admin-zlecenie-detale",
            params: { id: item.id },
          })
        }
      >
  ...
  // NOWOŚĆ: Filtrujemy listę na żywo!
  // Jeśli wpiszesz "ZD 4", aplikacja zostawi tylko te zlecenia, które mają w nazwie "ZD 4"
  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.subtitle}>Lista zleceń na produkcji</Text>
      </View>

      {/* NOWOŚĆ: Pole wyszukiwarki */}
      <View style={styles.searchContainer}>
        <TextInput
          ...
          clearButtonMode="while-editing" // Pojawia się 'x' do szybkiego czyszczenia na iOS
        />
      </View>
      ...
      {loading ? (
        ...
        <FlatList
          // Zamiast całej listy 'zlecenia', przekazujemy naszą przefiltrowaną listę:
