...
export default function PanelBiuroScreen() {
  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        <Text style={styles.title}>Panel Biurowy</Text>
      ...
      >
        {/* KAFELEK 1: Wprowadzanie (Biuro) */}
        <TouchableOpacity
          style={[styles.card, { borderTopColor: "#10b981" }]}
          onPress={() => router.push("/biuro-dodaj-zlecenie")}
        >
          <Text style={styles.cardIcon}>📦</Text>
          <Text style={styles.cardTitle}>Wprowadzanie Zleceń</Text>
          <Text style={styles.cardDesc}>
            Skanuj kody z Subiekta i dodawaj nowe zlecenia (ZD) do systemu.
          </Text>
        </TouchableOpacity>

        {/* KAFELEK 2: Podgląd (Biuro) */}
        <TouchableOpacity
          style={[styles.card, { borderTopColor: "#f59e0b" }]}
          onPress={() => router.push("/biuro-lista-zlecen")}
        >
          <Text style={styles.cardIcon}>📋</Text>
          <Text style={styles.cardTitle}>Podgląd Zleceń</Text>
          <Text style={styles.cardDesc}>
            Wyszukuj zlecenia, sprawdzaj statusy na produkcji i wyświetlaj
            historię.
          </Text>
        </TouchableOpacity>
      </ScrollView>
